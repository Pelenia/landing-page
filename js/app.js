...
return content;}
module.exports={isArray:isArray,isArrayBuffer:isArrayBuffer,isBuffer:isBuffer,isFormData:isFormData,isArrayBufferView:isArrayBufferView,isString:isString,isNumber:isNumber,isObject:isObject,isPlainObject:isPlainObject,isUndefined:isUndefined,isDate:isDate,isFile:isFile,isBlob:isBlob,isFunction:isFunction,isStream:isStream,isURLSearchParams:isURLSearchParams,isStandardBrowserEnv:isStandardBrowserEnv,forEach:forEach,merge:merge,extend:extend,trim:trim,stripBOM:stripBOM};}),"./node_modules/lodash/lodash.js":/*!***************************************!*\
...
return ContinueSentinel;}};return exports;}(true?module.exports:undefined));try{regeneratorRuntime=runtime;}catch(accidentalStrictMode){Function("r","regeneratorRuntime = r")(runtime);}}),"./node_modules/toastify-js/src/toastify.js":/*!**************************************************!*\
...
*/(function(root,factory){if(true&&module.exports){module.exports=factory();}else{root.Toastify=factory();}})(this,function(global){var Toastify=function(options){return new Toastify.lib.init(options);},version="1.11.1";Toastify.defaults={oldestFirst:true,text:"Toastify is awesome!",node:undefined,duration:3000,selector:undefined,callback:function(){},destination:undefined,newWindow:false,close:false,gravity:"toastify-top",positionLeft:false,position:'',backgroundColor:'',avatar:"",className:"",stopOnFocus:true,onClick:function(){},offset:{x:0,y:0},escapeMarkup:true,style:{background:''}};Toastify.lib=Toastify.prototype={toastify:version,constructor:Toastify,init:function(options){if(!options){options={};}
this.options={};this.toastElement=null;this.options.text=options.text||Toastify.defaults.text;this.options.node=options.node||Toastify.defaults.node;this.options.duration=options.duration===0?0:options.duration||Toastify.defaults.duration;this.options.selector=options.selector||Toastify.defaults.selector;this.options.callback=options.callback||Toastify.defaults.callback;this.options.destination=options.destination||Toastify.defaults.destination;this.options.newWindow=options.newWindow||Toastify.defaults.newWindow;this.options.close=options.close||Toastify.defaults.close;this.options.gravity=options.gravity==="bottom"?"toastify-bottom":Toastify.defaults.gravity;this.options.positionLeft=options.positionLeft||Toastify.defaults.positionLeft;this.options.position=options.position||Toastify.defaults.position;this.options.backgroundColor=options.backgroundColor||Toastify.defaults.backgroundColor;this.options.avatar=options.avatar||Toastify.defaults.avatar;this.options.className=options.className||Toastify.defaults.className;this.options.stopOnFocus=options.stopOnFocus===undefined?Toastify.defaults.stopOnFocus:options.stopOnFocus;this.options.onClick=options.onClick||Toastify.defaults.onClick;this.options.offset=options.offset||Toastify.defaults.offset;this.options.escapeMarkup=options.escapeMarkup!==undefined?options.escapeMarkup:Toastify.defaults.escapeMarkup;this.options.style=options.style||Toastify.defaults.style;this.options.style.background=Toastify.defaults.backgroundColor||options.backgroundColor;return this;},buildToast:function(){if(!this.options){throw "Toastify is not initialized";}
...
return divElement;},showToast:function(){this.toastElement=this.buildToast();var rootElement;if(typeof this.options.selector==="string"){rootElement=document.getElementById(this.options.selector);}else if(this.options.selector instanceof HTMLElement||this.options.selector instanceof ShadowRoot){rootElement=this.options.selector;}else{rootElement=document.body;}
...
Toastify.lib.init.prototype=Toastify.lib;return Toastify;});}),"./node_modules/webpack/buildin/global.js":/*!***********************************!*\
...
return module;};}),"./resources/js/UI/loading.js":/*!************************************!*\
!*** ./resources/js/UI/loading.js ***!
\************************************//*!no static exports found*/(function(module,exports){var load=document.querySelector('#loading');document.addEventListener('DOMContentLoaded',function(e){load.classList.add('loader-fade');load.classList.add('hidden');});}),"./resources/js/UI/mobileMenu.js":/*!***************************************!*\
!*** ./resources/js/UI/mobileMenu.js ***!
\***************************************//*!no static exports found*/(function(module,exports){if(document.querySelector('#mobile-menu-btn')){var mobileMenuBtn=document.querySelector('#mobile-menu-btn');var mobileMenu=document.querySelector('#mobile-menu');mobileMenuBtn.addEventListener('click',function(e){mobileMenu.classList.remove('hidden');});mobileMenu.querySelector('button').addEventListener('click',function(e){mobileMenu.classList.add('hidden');});}}),"./resources/js/UI/moveToDesktop.js":/*!******************************************!*\
!*** ./resources/js/UI/moveToDesktop.js ***!
\******************************************//*!no static exports found*/(function(module,exports){$(document).ready(function(){console.log('ready');var vw=Math.max(document.documentElement.clientWidth||0,window.innerWidth||0);if(vw<=991){console.log(vw);console.log('client is considered mobile');$('#move-to-desktop-modal').modal({backdrop:'static',keyboard:false,show:true});}});}),"./resources/js/UI/slider.js":/*!***********************************!*\
!*** ./resources/js/UI/slider.js ***!
\***********************************//*!no static exports found*/(function(module,exports){$(document).ready(function(e){if(window.location.pathname!=='/'){$('#skills').select2();$('.slider-element').slider({tooltip:'always'});}});}),"./resources/js/app.js":/*!*****************************!*\
!*** ./resources/js/app.js ***!
\*****************************//*!no static exports found*/(function(module,exports,__webpack_require__){__webpack_require__(/*!./bootstrap*/"./resources/js/bootstrap.js");__webpack_require__(/*!./landingPages/landingPage*/"./resources/js/landingPages/landingPage.js");__webpack_require__(/*!./UI/moveToDesktop*/"./resources/js/UI/moveToDesktop.js");__webpack_require__(/*!./UI/slider*/"./resources/js/UI/slider.js");__webpack_require__(/*!./UI/loading*/"./resources/js/UI/loading.js");__webpack_require__(/*!./UI/mobileMenu*/"./resources/js/UI/mobileMenu.js");__webpack_require__(/*!./zilliqa*/"./resources/js/zilliqa.js");__webpack_require__(/*!./components/zilpubkeys*/"./resources/js/components/zilpubkeys.js");__webpack_require__(/*!./components/depositPele*/"./resources/js/components/depositPele.js");__webpack_require__(/*!./components/withdrawPele*/"./resources/js/components/withdrawPele.js");}),"./resources/js/bootstrap.js":/*!***********************************!*\
!*** ./resources/js/bootstrap.js ***!
\***********************************//*!no static exports found*/(function(module,exports,__webpack_require__){window._=__webpack_require__(/*!lodash*/"./node_modules/lodash/lodash.js");window.axios=__webpack_require__(/*!axios*/"./node_modules/axios/index.js");window.axios.defaults.headers.common['X-Requested-With']='XMLHttpRequest';}),"./resources/js/components/depositPele.js":/*!************************************************!*\
!*** ./resources/js/components/depositPele.js ***!
\************************************************//*!no exports provided*/(function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*!@babel/runtime/regenerator*/"./node_modules/@babel/runtime/regenerator/index.js");var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);var toastify_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*!toastify-js*/"./node_modules/toastify-js/src/toastify.js");var toastify_js__WEBPACK_IMPORTED_MODULE_1___default=__webpack_require__.n(toastify_js__WEBPACK_IMPORTED_MODULE_1__);function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}
function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}
$(document).ready(function(){if(window.zilPay==undefined){return;}
function verifyDeposit(_x){return _verifyDeposit.apply(this,arguments);}
function _verifyDeposit(){_verifyDeposit=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7(txn){var result;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:if(!(txn==undefined)){_context7.next=2;break;}
return _context7.abrupt("return");case 2:txn=JSON.parse(txn);_context7.next=5;return window.zilPay.wallet.observableTransaction(txn.tx_hash).subscribe(function(hashs){console.log(hashs);recordDeposit(txn);});case 5:result=_context7.sent;console.log(result);_context7.next=9;return result;case 9:return _context7.abrupt("return",_context7.sent);case 10:case "end":return _context7.stop();}}},_callee7);}));return _verifyDeposit.apply(this,arguments);}
verifyDeposit(localStorage.getItem('deposit'));function recordDeposit(_x2){return _recordDeposit.apply(this,arguments);}
function _recordDeposit(){_recordDeposit=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8(data){var csrf;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:_context8.next=2;return document.querySelector('meta[name="csrf-token"]');case 2:csrf=_context8.sent;console.log(localStorage.getItem('deposit'));_context8.next=6;return fetch("/pele/deposit",{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json','X-Requested-With':'XMLHttpRequest','X-CSRF-Token':csrf.content},body:JSON.stringify(data)}).then(function(response){return response.json();}).then(function(data){console.log('Success:',data);})["catch"](function(error){console.error('Error:',error);});case 6:_context8.next=8;return localStorage.removeItem('deposit');case 8:toastify_js__WEBPACK_IMPORTED_MODULE_1___default()({text:'We verfied your deposit Request, refresh and check your account',duration:10000,close:true,gravity:'top',position:'center',backgroundColor:'#3E605F',stopOnFocus:true,onClick:function onClick(e){location.reload();}}).showToast();case 9:case "end":return _context8.stop();}}},_callee8);}));return _recordDeposit.apply(this,arguments);}
$('#depositrequest').on('shown.bs.modal',function(){var _ref=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6(e){var depositForm,contract,base16Address,bech32Address,selectedAddress,balance,sliderMax,slider;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:_context6.next=2;return document.querySelector('#deposit-pele');case 2:depositForm=_context6.sent;_context6.next=5;return window.zilPay.contracts.at("0x55d66385a975a25cd7c9bb7cb8b1b11a56436789");case 5:contract=_context6.sent;_context6.next=8;return window.zilPay.wallet.defaultAccount.base16.toLowerCase();case 8:base16Address=_context6.sent;_context6.next=11;return window.zilPay.wallet.defaultAccount.bech32;case 11:bech32Address=_context6.sent;_context6.next=14;return document.querySelector('#deposit-address');case 14:selectedAddress=_context6.sent;selectedAddress.innerHTML=bech32Address;_context6.next=18;return contract.getState().then(function(a){var contractState=a.balances;return contractState[base16Address];});case 18:balance=_context6.sent;sliderMax=(balance*.00001).toString();balance=(balance*.00001).toLocaleString('en-US');console.log(balance);depositForm.querySelector('em').innerText="max: ".concat(balance);slider=new Slider('#deposit-amount',{tooltip:'always',min:0,max:sliderMax});slider.on("slide",function(slideEvt){$('#deposit-amount').val(slider.getValue());});$(this).on('hidden.bs.modal',function(){var _ref2=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:slider.destroy();case 1:case "end":return _context.stop();}}},_callee);}));return function(_x4){return _ref2.apply(this,arguments);};}());$('#deposit-confirmation').on('shown.bs.modal',function(){var _ref3=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(e){var amountToDeposit;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:amountToDeposit=slider.getValue();_context5.next=3;return "address: ".concat(bech32Address);case 3:document.querySelector('#confirm-deposit-address').innerHTML=_context5.sent;_context5.next=6;return "amount: ".concat(slider.getValue());case 6:document.querySelector('#confirm-deposit-amount').innerHTML=_context5.sent;$(this).on('hidden.bs.modal',function(e){$('#submit-deposit').attr('disabled',false);});$('#submit-deposit').on('click',function(){var _ref4=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(e){var utils,amount,gasPrice,userID,tx;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:$(this).attr('disabled',true);_context4.next=3;return window.zilPay.utils;case 3:utils=_context4.sent;_context4.next=6;return utils.units.toQa(0,utils.units.Units.Zil);case 6:amount=_context4.sent;_context4.next=9;return utils.units.toQa('1000',utils.units.Units.Li);case 9:gasPrice=_context4.sent;_context4.next=12;return document.querySelector('#username');case 12:userID=_context4.sent;_context4.next=15;return contract.call('Transfer',[{vname:'to',type:'ByStr20',value:'0xc8123BA77A47945fafB74d4acFdC9351d5a4F016'},{vname:'amount',type:'Uint128',value:(amountToDeposit*10000).toString()}],{amount:amount,gasPrice:gasPrice,gasLimit:utils.Long.fromNumber(9000)}).then(function(){var _ref5=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(tx,contract){var data;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:console.log(tx);_context2.next=3;return{'pub_key':window.zilPay.wallet.defaultAccount.base16,'amount':slider.getValue().toString(),'user_id':userID.value,'tx_hash':tx.TranID};case 3:data=_context2.sent;console.log(data);_context2.next=7;return localStorage.setItem('deposit',JSON.stringify(data));case 7:return _context2.abrupt("return",tx);case 8:case "end":return _context2.stop();}}},_callee2);}));return function(_x7,_x8){return _ref5.apply(this,arguments);};}());case 15:tx=_context4.sent;_context4.next=18;return window.zilPay.wallet.observableTransaction(tx.ID).subscribe(function(){var _ref6=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(hashs){var userID,data;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:console.log(hashs);_context3.next=3;return document.querySelector('#username');case 3:userID=_context3.sent;_context3.next=6;return{'pub_key':window.zilPay.wallet.defaultAccount.base16,'amount':slider.getValue().toString(),'user_id':userID.value,'tx_hash':hashs[0]};case 6:data=_context3.sent;recordDeposit(data);case 8:case "end":return _context3.stop();}}},_callee3);}));return function(_x9){return _ref6.apply(this,arguments);};}());case 18:case "end":return _context4.stop();}}},_callee4,this);}));return function(_x6){return _ref4.apply(this,arguments);};}());case 9:case "end":return _context5.stop();}}},_callee5,this);}));return function(_x5){return _ref3.apply(this,arguments);};}());case 27:case "end":return _context6.stop();}}},_callee6,this);}));return function(_x3){return _ref.apply(this,arguments);};}());});}),"./resources/js/components/withdrawPele.js":/*!*************************************************!*\
!*** ./resources/js/components/withdrawPele.js ***!
\*************************************************//*!no exports provided*/(function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*!@babel/runtime/regenerator*/"./node_modules/@babel/runtime/regenerator/index.js");var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);var _toastify__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*!../toastify*/"./resources/js/toastify.js");function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}
function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}
$(document).ready(function(){if(window.zilPay==undefined){return;}
function hideModals(){$('#withdraw-confirmation').modal('hide');$('#withdrawrequest').modal('hide');}
var bech32Address=window.zilPay.wallet.defaultAccount.bech32;var sliderValue=document.querySelector('#withdraw-amount');var addressList=document.querySelector('.withdraw-select');var selectedAddress=bech32Address;$('#withdrawrequest').on('shown.bs.modal',function(){var _ref=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:addressList.querySelector("option[value=".concat(bech32Address,"]")).selected=true;$('.withdraw-select').on('change',function(e){selectedAddress=e.target.value;});case 2:case "end":return _context.stop();}}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}());$('#withdraw-confirmation').on('shown.bs.modal',function(){var _ref2=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(e){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return "address: ".concat(selectedAddress);case 2:document.querySelector('#confirm-withdraw-address').innerHTML=_context2.sent;_context2.next=5;return "amount: ".concat(sliderValue.value);case 5:document.querySelector('#confirm-withdraw-amount').innerHTML=_context2.sent;$(this).on('hidden.bs.modal',function(e){$('#withdraw-submit').attr('disabled',false);});case 7:case "end":return _context2.stop();}}},_callee2,this);}));return function(_x2){return _ref2.apply(this,arguments);};}());$('#withdraw-submit').on('click',function(){var _ref3=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(e){var csrf,userID,base16Address,data;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return document.querySelector('meta[name="csrf-token"]');case 2:csrf=_context3.sent;_context3.next=5;return document.querySelector('#username');case 5:userID=_context3.sent;base16Address=window.zilPay.crypto.fromBech32Address(selectedAddress).toLowerCase();$(this).attr('disabled',true);console.log(window.zilPay.crypto.fromBech32Address(selectedAddress));data={'user_id':userID.value,'public_key':selectedAddress,'legacy_pub_key':base16Address,'amount':sliderValue.value};console.log(data);_context3.next=13;return fetch('/pele/withdraw',{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json','X-Requested-With':'XMLHttpRequest','X-CSRF-Token':csrf.content},body:JSON.stringify(data)}).then(function(response){return response.json();}).then(function(data){console.log('Success:',data);if(data.error){Object(_toastify__WEBPACK_IMPORTED_MODULE_1__["default"])(data.error,'#dc3545',hideModals);}else if(data.exception){Object(_toastify__WEBPACK_IMPORTED_MODULE_1__["default"])(data.message+' check the web console for more details.','#dc3545',hideModals);}else{Object(_toastify__WEBPACK_IMPORTED_MODULE_1__["default"])('We recieved your withdraw request, please give us time to verify it on our end.','#3E605F',hideModals);}})["catch"](function(error){console.error('Error:',error);Object(_toastify__WEBPACK_IMPORTED_MODULE_1__["default"])("error: ".concat(error),'#dc3545',hideModals);});case 13:case "end":return _context3.stop();}}},_callee3,this);}));return function(_x3){return _ref3.apply(this,arguments);};}());});}),"./resources/js/components/zilpubkeys.js":/*!***********************************************!*\
!*** ./resources/js/components/zilpubkeys.js ***!
\***********************************************//*!no exports provided*/(function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*!@babel/runtime/regenerator*/"./node_modules/@babel/runtime/regenerator/index.js");var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);function _createForOfIteratorHelper(o){if(typeof Symbol==="undefined"||o[Symbol.iterator]==null){if(Array.isArray(o)||(o=_unsupportedIterableToArray(o))){var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var it,normalCompletion=true,didErr=false,err;return{s:function s(){it=o[Symbol.iterator]();},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}
...
function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}
if(document.querySelector('#addresses')){var addrTab=document.querySelector('#addresses');var csrf=document.querySelector('meta[name="csrf-token"]');var userID=document.querySelector('#username').value;addrTab.addEventListener('click',function(){var _ref=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:fetch("/pubkey?id=".concat(userID),{headers:{'Content-Type':'application/json','Accept':'application/json','X-Requested-With':'XMLHttpRequest','X-CSRF-Token':csrf.content}}).then(function(response){return response.json();}).then(function(data){console.log('Success:',data);var addressList=document.querySelector('#public-address-list');addressList.innerHTML='';var _iterator=_createForOfIteratorHelper(data.data),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var address=_step.value;var p=document.createElement('span');p.innerHTML=address;addressList.append(p);}}catch(err){_iterator.e(err);}finally{_iterator.f();}})["catch"](function(error){console.error('Error:',error);});case 1:case "end":return _context.stop();}}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}());}}),"./resources/js/landingPages/landingPage.js":/*!**************************************************!*\
!*** ./resources/js/landingPages/landingPage.js ***!
\**************************************************//*!no static exports found*/(function(module,exports){var timeOutFunctionId;function getValueFromPx(inputString){return parseInt(inputString.replace(/px/,""));}
function initAccordionHeight(){$("[data-click='faq']").each(function(){var myHeight=getValueFromPx($(this).find(".faq-head").css("height"));var mypadding=getValueFromPx($(this).css("padding-top"))*2;var myHeightP=getValueFromPx($(this).find(".faq-text").css("height"));var rowSpace=getValueFromPx($(this).css("row-gap"));if($(this).find(".faq-text").css("opacity")==0){myHeight=myHeight+mypadding+"px";$(this).removeClass('open');}
else if($(this).is('.open')){myHeight=myHeight+mypadding+myHeightP+rowSpace+"px";}
else{myHeight=myHeight+mypadding+"px";}
$(this).css("max-height",myHeight);});}
function initWindowResizer(){window.addEventListener("resize",function(){clearTimeout(timeOutFunctionId);timeOutFunctionId=setTimeout(initAccordionHeight,250);});}
function addAccordionClickHandler(){$("[data-click='faq']").click(function(){if(!$(this).is('.open')){$('[data-click="faq"].open').each(function(i,item){item.click();});var myHeight=getValueFromPx($(this).find(".faq-head").css("height"));var mypadding=getValueFromPx($(this).css("padding-top"));var myHeightP=getValueFromPx($(this).find(".faq-text").css("height"));var rowSpace=getValueFromPx($(this).css("row-gap"));myHeight=myHeight+mypadding*2+myHeightP+rowSpace+"px";$(this).css("max-height",myHeight);$(this).addClass('open');}
else{var myHeight=getValueFromPx($(this).find(".faq-head").css("height"));var mypadding=getValueFromPx($(this).css("padding-top"));myHeight=myHeight+mypadding*2+"px";$(this).css("max-height",myHeight);$(this).removeClass('open');}});}
function initMobileNav(){var targetElement=document.querySelector('#mnav');$("#open").bind("click",function(e){bodyScrollLock.disableBodyScroll(targetElement);});$("#close").bind("click",function(e){bodyScrollLock.clearAllBodyScrollLocks();});$(window).on("orientationchange",function(event){bodyScrollLock.clearAllBodyScrollLocks();});}
$(document).ready(function(){initAccordionHeight();addAccordionClickHandler();initWindowResizer();initMobileNav();$('.hover-pane-video').on('click',function(e){$(this).addClass('hidden');var video=$('.video-embed').find('video').get(0);video.setAttribute('controls',true);video.muted=false;video.play();});});}),"./resources/js/toastify.js":/*!**********************************!*\
!*** ./resources/js/toastify.js ***!
\**********************************//*!exports provided: default*/(function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,"default",function(){return toast;});var toastify_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*!toastify-js*/"./node_modules/toastify-js/src/toastify.js");var toastify_js__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(toastify_js__WEBPACK_IMPORTED_MODULE_0__);function toast(message,color,onLeave){var duration=arguments.length>3&&arguments[3]!==undefined?arguments[3]:10000;if(typeof color!=='string'){console.error('color needs to be of type string');return;}
if(typeof message!=='string'){console.error('message needs to be of type string.');return;}
if(typeof onLeave!=='function'){console.error('onLeave needs to be of type function.');return;}
toastify_js__WEBPACK_IMPORTED_MODULE_0___default()({text:message,duration:duration,close:true,gravity:'top',position:'center',backgroundColor:color,stopOnFocus:true,onClick:function onClick(e){document.querySelector('.toast-close').click();},callback:onLeave}).showToast();}}),"./resources/js/zilliqa.js":/*!*********************************!*\
!*** ./resources/js/zilliqa.js ***!
\*********************************//*!no exports provided*/(function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*!@babel/runtime/regenerator*/"./node_modules/@babel/runtime/regenerator/index.js");var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);var toastify_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*!toastify-js*/"./node_modules/toastify-js/src/toastify.js");var toastify_js__WEBPACK_IMPORTED_MODULE_1___default=__webpack_require__.n(toastify_js__WEBPACK_IMPORTED_MODULE_1__);function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}
function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}
var zilliqa=window.zilPay;var isLoggedIn=window.isLoggedIn;var prompt=document.querySelector('#registerWalletrequest');var connectBtn=document.querySelector('#connect');var pubAddress=document.querySelector('#client-pub-address');var userBalance=document.querySelector('#balance');var csrf=document.querySelector('meta[name="csrf-token"]');if(typeof window.zilPay!=='undefined'){if(isLoggedIn){if(window.zilPay.wallet.net==null){console.log('you\'re not connected to any network...');}
console.log("You are currently on this network: %c".concat(zilliqa.wallet.net),'color:red;');if(window.zilPay.wallet.isEnable&&window.zilPay.wallet.isConnect){console.log(window.zilPay);connectBtn.innerHTML="Connected";console.log('wallet access granted.');var _short=displayShortPublicAddress(window.zilPay.wallet.defaultAccount.bech32);pubAddress.classList.remove('hidden');pubAddress.querySelector('#short-id-wallet').innerHTML=_short;if(userBalance!=undefined){userBalance.innerHTML="".concat(window.zilPay.wallet.defaultAccount.bech32);}
storePubKey({'pubKey':window.zilPay.wallet.defaultAccount.bech32},csrf);confirm();}else{console.log('wallet is not enabled');console.log(window.zilPay);connectBtn.innerHTML="Connect ZilPay";connectBtn.addEventListener('click',function(){var _ref=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e){var balance;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return connectWallet(e);case 2:_context.next=4;return displayZilBalance();case 4:balance=_context.sent;_context.next=7;return confirm();case 7:case "end":return _context.stop();}}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}());}}else{console.log('login to use your zilpay wallet');connectBtn.classList.add('hidden');}}else{console.log('install zilpay for a better experience!');connectBtn.classList.add('bg-secondary');connectBtn.innerHTML="activate zilpay plugin";}
function displayZilBalance(){return _displayZilBalance.apply(this,arguments);}
function _displayZilBalance(){_displayZilBalance=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(){var result;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(!zilliqa.wallet.isEnable){_context2.next=9;break;}
_context2.next=3;return zilliqa.blockchain.getBalance(zilliqa.wallet.defaultAccount.bech32).then(function(wallet){var res=wallet.result.balance;console.log(res);return res;});case 3:result=_context2.sent;_context2.next=6;return result;case 6:return _context2.abrupt("return",_context2.sent);case 9:return _context2.abrupt("return",false);case 10:case "end":return _context2.stop();}}},_callee2);}));return _displayZilBalance.apply(this,arguments);}
function connectWallet(button){console.log('made it here');zilliqa.wallet.connect().then(function(accounts){if(accounts){console.log('send request to server maybe?');button.target.innerHTML="Connected";prompt.querySelector('.close').click();var _short2=displayShortPublicAddress(window.zilPay.wallet.defaultAccount.bech32);pubAddress.classList.remove('hidden');pubAddress.querySelector('#short-id-wallet').innerHTML=_short2;storePubKey({'pubKey':window.zilPay.wallet.defaultAccount.bech32},csrf);}else{button.target.innerHTML="Error! User Rejected.";button.target.style.backgroundColor="red";throw new Error('user rejected');}})["catch"](function(error){console.log(error);});}
function displayShortPublicAddress(clientWallet){if(typeof clientWallet!=='string'){throw new Error('function displayShortPublicAddress requires a bech32 string');}else{return 'zil...'+clientWallet.slice(clientWallet.length-6);}}
function storePubKey(_x2,_x3){return _storePubKey.apply(this,arguments);}
function _storePubKey(){_storePubKey=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(data,csrfField){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return document.querySelector('#username').value;case 2:data.userID=_context3.sent;console.log(data);_context3.next=6;return fetch("/pubkey/store",{method:'POST',headers:{"Content-Type":"application/json","Accept":"application/json","X-Requested-With":"XMLHttpRequest","X-CSRF-Token":csrfField.content},body:JSON.stringify(data)}).then(function(response){return response.json();}).then(function(data){console.log('Success:',data);})["catch"](function(error){console.error('Error:',error);});case 6:case "end":return _context3.stop();}}},_callee3);}));return _storePubKey.apply(this,arguments);}
function confirm(){return _confirm.apply(this,arguments);}
function _confirm(){_confirm=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(){var tx,userID,tokenPlanID,block;return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return localStorage.getItem('tx');case 2:tx=_context4.sent;_context4.next=5;return document.querySelector('#username');case 5:userID=_context4.sent;_context4.next=8;return localStorage.getItem('token_plan_id');case 8:tokenPlanID=_context4.sent;console.log(userID.value);if(!tx){_context4.next=16;break;}
console.log('attempting to confirm');_context4.next=14;return window.zilPay.wallet.observableTransaction(tx).subscribe(function(hashs){console.log(hashs);payWithZilPay({user:userID.value,tx:hashs[0],id:tokenPlanID});});case 14:block=_context4.sent;console.log(block);case 16:case "end":return _context4.stop();}}},_callee4);}));return _confirm.apply(this,arguments);}
function payWithZilPay(_x4){return _payWithZilPay.apply(this,arguments);}
function _payWithZilPay(){_payWithZilPay=_asyncToGenerator(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(data){return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:_context5.next=2;return fetch("/user/zilpay/".concat(data.id),{method:'POST',headers:{"Content-Type":"application/json","Accept":"application/json","X-Requested-With":"XMLHttpRequest","X-CSRF-Token":csrf.content},body:JSON.stringify(data)}).then(function(response){return response.json();}).then(function(data){console.log('Success:',data);})["catch"](function(error){console.error('Error:',error);});case 2:_context5.next=4;return localStorage.removeItem('token_plan_id');case 4:_context5.next=6;return localStorage.removeItem('tx');case 6:toastify_js__WEBPACK_IMPORTED_MODULE_1___default()({text:"We verfied your transaction, refresh and check your account ",duration:10000,close:true,gravity:"top",position:"center",backgroundColor:"#3E605F",stopOnFocus:true,onClick:function onClick(e){location.reload();}}).showToast();case 7:case "end":return _context5.stop();}}},_callee5);}));return _payWithZilPay.apply(this,arguments);}}),"./resources/sass/app.scss":/*!*********************************!*\
!*** ./resources/sass/app.scss ***!
\*********************************//*!no static exports found*/(function(module,exports){}),0:/*!*************************************************************!*\
!*** multi ./resources/js/app.js ./resources/sass/app.scss ***!
\*************************************************************//*!no static exports found*/(function(module,exports,__webpack_require__){__webpack_require__(/*!/Applications/MAMP/htdocs/pele-backend/resources/js/app.js*/"./resources/js/app.js");module.exports=__webpack_require__(/*!/Applications/MAMP/htdocs/pele-backend/resources/sass/app.scss*/"./resources/sass/app.scss");})});